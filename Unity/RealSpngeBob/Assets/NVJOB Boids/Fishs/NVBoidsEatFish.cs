...
public class NVBoidsEatFish: MonoBehaviour
{
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    void BirdsMove()
    {
        ...
        {
            if (GameObject.FindGameObjectWithTag("FishFeed") == null) // FishFeed 태그의 게임 오브젝트가 없는지 확인
            {
    ...
    void CreateBird()
    {
        ...
        for (int b = 0; b < birdsNum; b++)
        {
            birdsTransform[b] = Instantiate(eatFishPref, thisTransform).transform;
            Vector3 lpv = Random.insideUnitSphere * fragmentedBirds;
